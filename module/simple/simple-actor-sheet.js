import { SimpleEntitySheetHelper } from "./simple-helper.js";
...
export class AranthozActorSheet_old extends ActorSheet {
  ...
  async getData(options) {
    ...
    SimpleEntitySheetHelper.getAttributeData(context.data);
  ...
  activateListeners(html) {
    ...
    html.find(".attributes").on("click", ".attribute-control", SimpleEntitySheetHelper.onClickAttributeControl.bind(this));
    html.find(".groups").on("click", ".group-control", SimpleEntitySheetHelper.onClickAttributeGroupControl.bind(this));
    html.find(".attributes").on("click", "a.attribute-roll", SimpleEntitySheetHelper.onAranthozAttributeRoll.bind(this));
    html.find(".items").on("click", "a.item-roll", SimpleEntitySheetHelper.onAranthozItemRoll.bind(this));
  ...
  _getSubmitData(updateData) {
    ...
    formData = SimpleEntitySheetHelper.updateAttributes(formData, this.object);
    formData = SimpleEntitySheetHelper.updateGroups(formData, this.object);
    return formData;
  }
}
...
export class SimpleActorSheet extends ActorSheet {
  ...
  activateListeners(html) {
    ...
    html.find(".attributes").on("click", ".attribute-control", SimpleEntitySheetHelper.onClickAttributeControl.bind(this));
    html.find(".groups").on("click", ".group-control", SimpleEntitySheetHelper.onClickAttributeGroupControl.bind(this));
    html.find(".attributes").on("click", "a.attribute-roll", SimpleEntitySheetHelper.onAttributeRoll.bind(this));
